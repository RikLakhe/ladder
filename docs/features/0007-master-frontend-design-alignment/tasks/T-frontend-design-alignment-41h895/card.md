## Task T-frontend-design-alignment-41h895 — <title>
...
**Test scope:** tests/T-frontend-design-alignment-41h895/   ← documentation: where this task's OWN tests live. Scope is NOT configured — red/green scope to the changed test files and `verify` derives it from the RED commits (ADR-0002); `review` runs the FULL suite. This line is a human pointer only.
